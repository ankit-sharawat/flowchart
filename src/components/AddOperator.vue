  ...
  <transition name="modal" v-if="show">
        ...
        <div class="modal-container">
          <div class="row">
            <div class="col-md-6" style="padding-right:0px;">
              <div class="img-container"><img src="../assets/medical-record.svg" class="file-icon" style="width:50px;"></img>
              </div>
    ...
    <span aria-hidden="true">&times;</span>
                ...
                <div class="parameterWrap" style="width:100%">
                  <span class="imgTop">
     <img src="../assets/medical-record.svg" class="file-icon" style="width:30px;"></img>
    </span>
                ...
                <div>
                  <h4 style="padding-right:36px; color:white;font-size: 23px;
